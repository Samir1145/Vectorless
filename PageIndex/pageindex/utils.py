        ...
        if avg_chars < 8:
            ...
            try:
                ...
                if ocr_list and any(t.strip() for t, _ in ocr_list):
                    ...
                    logging.warning("get_page_tokens: OCR returned empty text — falling back to original")
            except Exception as e:
                logging.warning("get_page_tokens: OCR fallback failed (%s) — using original empty text", e)
